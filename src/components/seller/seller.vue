  ...
  <div class="seller" v-el:seller>
    <div class="seller-content">
      <div class="overview">
        ...
        <div class="desc borderbottom-1px">
      ...
      <div class="bulletin">
        ...
        <div class="content-wrapper borderbottom-1px">
          <p class="content-in">{{seller.bulletin}}</p>
        </div>
        <ul v-if="seller.supports" class="supports">
          <li class="support-item borderbottom-1px" v-for="item in seller.supports">
      ...
      <split></split>
      <div class="info">
        <h1 class="info-title borderbottom-1px">商家信息</h1>
        <ul>
